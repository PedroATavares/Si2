...
exec alteracoesPrecario '2018-01-01','2019-01-01',30,15,1
-- é espectavel que na tabela PrecoAluguer com a data inicio-> 2018-01-01, duracao-> 30 e EquipId-> 1
...
--select * from Aluguer
declare @id int
exec InserirAluguerComCliente '2017-11-20','2018-11-21',40,1,1,@id output
select @id
-- é espectavel inserir na tabela Aluguer 
-- com a data inicio->2017-11-20, data fim->2018-11-21, duracao-> 40, Numero do Empregado->1 e Codigo do Cliente-> 1
...
exec InserirAluguerSemCliente 101,'NomeTeste','MoradaTeste',@idCliente output,25,1,'2018-10-20','2018-10-21',@idAluguer output
...
-- o Cliente pussui data inicio ->2018-10-20, data fim->2018-10-21, duracao->25, Num empregado->1
...
declare @idA int
exec InserirAluguerComCliente '2018-12-05 01:00:00', '2018-12-05 02:00:00',60,1,1,@idA

 update
 Aluguer 
 set DataInicio='2018-12-01'
 where Num=@idA
